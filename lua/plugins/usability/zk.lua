return {
	...
	keys = {
		...
		{
			"<leader>zd",
			"<Cmd>cd ~/.sazima1/notes<CR><Cmd>ZkNew { dir = 'daily' }<CR>",
			mode = "n",
			noremap = true,
			silent = false,
		...
		{
			"<leader>zo",
			"<Cmd>cd ~/.sazima1/notes<CR><Cmd>ZkNotes { sort = { 'modified' } }<CR>",
			mode = "n",
			noremap = true,
			silent = false,
			desc = "Open notes",
		...
		{
			"<leader>zt",
			"<Cmd>cd ~/.sazima1/notes<CR><Cmd>ZkTags<CR>",
			mode = "n",
			noremap = true,
			silent = false,
		...
		{
			"<leader>zf",
			"<Cmd>cd ~/.sazima1/notes<CR><Cmd>'<,'>ZkMatch<CR>",
			mode = "v",
			noremap = true,
			silent = false,
